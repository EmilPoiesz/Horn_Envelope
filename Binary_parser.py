...
class Binary_parser:
    ...
    def __init__(self, country_filepath:str, occupation_filepath:str):
        self.continent_lookup  = self.initialize_country_continent_lookup(country_filepath)
    ...
    def initialize_country_continent_lookup(self, country_file : str):
        """
        Reads the file containing the countries and continents and creates a continent lookup table.

        Args:
            The filepath to the file containing all the countries and their corresponding continents.
        Returns:
